...
import { getDomainTracks, getFeaturedCourses, getFeaturedFreelancers, stats } from "@/lib/data";
...
export default function Home() {
  ...
  return (
    <PageShell>
      ...
      <section id="about" className="shell mt-18">
        <SectionHeading
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-3 text-sm leading-7 text-[var(--color-copy)]">
              Structured courses cover digital work, craft commerce, tourism operations,
              and agriculture-ready business skills.
            </p>
          </article>
          <article className="section-card p-6" style={{ borderLeftColor: "var(--color-slate)" }}>
            <p className="eyebrow mb-3">02 Certify</p>
            <h3 className="display-heading text-2xl">Earn proof of capability</h3>
            <p className="mt-3 text-sm leading-7 text-[var(--color-copy)]">
              Certificates make learning visible and ready for employer trust, profile
              building, and role matching.
            </p>
          </article>
          <article className="section-card p-6" style={{ borderLeftColor: "var(--color-moss)" }}>
            <p className="eyebrow mb-3">03 Work</p>
            <h3 className="display-heading text-2xl">Start taking gigs</h3>
            <p className="mt-3 text-sm leading-7 text-[var(--color-copy)]">
              Departments, NGOs, homestays, craft groups, and remote clients can discover
              talent by skill, district, and availability.
            </p>
          </article>
        </div>
      </section>
